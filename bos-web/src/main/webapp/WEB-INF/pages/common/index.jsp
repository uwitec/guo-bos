...
<script type="text/javascript">
	...
	// 版权信息
	function showAbout(){
		$.messager.alert("宅急送 v1.0","管理员邮箱: gxx632364@gmail.com");
	}
</script>
</head>
				...
				<tr>
					<td style="width: 300px;">
						<div style="color: #999; font-size: 8pt;">
							<span style="color: #488ED5;">免责声明：项目原型来自～黑马，本项目仅供自己学习使用！！！| Powered by <a href="http://www.itheima.com//" target="_blank">www.itheima.com</a></span>
						</div>
					</td>
